...
export const isResult = <Value, Err extends ResultError>(
    resultCandidate: any,
): resultCandidate is Result<Value, Err> => {
...
export const isErrorType = <E extends ResultError>(
    errorCandidate: any,
    tag: E[typeof ErrorTag],
): errorCandidate is E => {
